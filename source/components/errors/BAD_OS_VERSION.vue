...
<template lang="html">
    <div>
        ...
        <p
            v-html="localize('error_compatibility_error_os_version_p1_text')"
        ></p>
        <p>{{ localize(`error_compatibility_error_os_version_p2_text`) }}</p>
        <div class="button-container">
            <button class="primary" @click="updateOS">
                {{
                    localize(
                        'error_compatibility_error_os_version_update_button_label'
                    )
                }}
            </button>
        </div>

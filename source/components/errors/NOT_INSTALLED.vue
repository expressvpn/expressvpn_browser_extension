...
export default {
  ...
  methods: {
    primaryClick() {
      let url = this.currentInfo.website_url + '/setup?utm_source=extension&utm_medium=apps&utm_campaign=browser_extension_links&utm_content=app_not_found_sign_in_to_set_up';
      if (this.isChromeOS === true) {
        url = 'https://play.google.com/store/apps/details?id=com.expressvpn.vpn&utm_source=extension&utm_medium=apps&utm_campaign=browser_extension_links&utm_content=app_not_found_get_started';
      }
      this.createTab({ url });
    },
    secondaryClick() {
      let url = '/order?utm_source=extension&utm_medium=apps&utm_campaign=browser_extension_links&utm_content=app_not_found_get_started';

      if (this.isChromeOS === true) {
        url = '/support/?utm_source=extension&utm_medium=apps&utm_campaign=browser_extension_links&utm_content=app_not_found_contact_support';
      }

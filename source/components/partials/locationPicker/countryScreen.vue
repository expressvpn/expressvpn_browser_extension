    ...
    <div class="country-screen">
        <div class="country-screen-header">
            <div
                ...
                @click="
                    $root.$emit('close-country-screen', {
                        scrollTop: country.scrollTop,
    ...
    computed: {
            ...
            let countryLocations =
                this.locationPicker.filterLocationsByProtocol(
                    this.country.region
                        ...
                        : this.currentInfo.recommendedLocationsList[
                              this.country.name
                          ],
        ...
        imgSrc() {
            ...
            return chrome.runtime.getURL(
                '/images/flags/' + iconName.toUpperCase() + '.svg'
            );
        },
    },
    components: {

    ...
    methods: {
        countryClick(event) {
            ...
            let emitObj = {
                name: country,
                code: country_code,
                scrollTop: document.querySelector('.location-list-container')
                    .scrollTop,
            };
        ...
        locationItemClick(event) {
            let is_smart_location =
                this.currentInfo.smartLocation.id === this.model.id;
            let is_country = this.type === 'country';
            let selectedLocation = Object.assign({}, this.model, {
                is_smart_location,
                is_country,
            });
            if (is_country === true) {

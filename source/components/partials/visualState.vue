    ...
    <svg width="350" height="185">
        <defs :class="['visual-state', `visual-state-${currentInfo.state}`]">
            <radialGradient
                ...
                fx="50%"
                fy="50%"
                gradientTransform="matrix(0 .99642 -1 0 1 .001789)"
            >
                <stop offset="0%" />
                <stop offset="100%" />
            </radialGradient>
            <radialGradient
                ...
                fx="50%"
                fy="50%"
                gradientTransform="matrix(0 .99536 -1 0 1 .00232)"
            >
                <stop offset="0%" />
                <stop offset="100%" />
            </radialGradient>
            <radialGradient
                ...
                fx="50%"
                fy="50%"
                gradientTransform="matrix(0 .99669 -1 0 1 .0016555)"
            >
                <stop offset="0%" />
                <stop offset="100%" />
            </radialGradient>
...
.visual-state {
    ...
    &-connecting radialGradient,
    &-disconnecting radialGradient,
    &-reconnecting radialGradient {
        stop[offset='0%'] {

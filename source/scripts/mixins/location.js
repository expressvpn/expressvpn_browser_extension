...
export default {
  ...
  methods: {
    updateLocationAndConnect: function (location) {
      ...
      chrome.runtime.sendMessage({
        ...
        selectedLocation: this.currentInfo.selectedLocation,
      });
  ...
  computed: {
    ...
    recommendedLocations() {
      const filteredLocations = locationsHelper.filterLocationsByProtocol(
      ...
      for (let [locationName, locationObj] of Object.entries(filteredLocations)) {
        if (
          ...
          recommendedLocations = Object.assign(recommendedLocations, {
